...
const ProductEditScreen = ({ history,match }) => {
  ...
  return (
    <>
      <Link to='/admin/productlist' className='btn btn-light mt-3'> <i className="fas fa-chevron-left pr-2"></i> Go back </Link>
    
    <FormContainer>
      <h4 className="p-2 bg-light text-dark border rounded">Edit Product</h4><br/>
